  ...
  return (
    <div className="text-center mt-20 max-w-2xl mx-auto">
      <h2 className="text-4xl font-bold mb-4 text-slate-900">
        Your Intelligent{" "}
        <span className="text-indigo-600">Scheme Navigator</span>
      </h2>
...
function KnowMoreModal({ scheme, onClose }) {
  return (
    ...
    >
      <div
        className="bg-white rounded-2xl p-8 max-w-xl w-full max-h-[85vh] overflow-y-auto"
      ...
      <div className="max-w-3xl mx-auto">
        ...
        {schemes.length === 0 ? (
          <div className="bg-white p-10 rounded-xl text-center text-slate-500 border border-slate-200">
            ...
            <p className="text-sm">
              Try adjusting your occupation or category.
            </p>
          </div>
        ) : (
