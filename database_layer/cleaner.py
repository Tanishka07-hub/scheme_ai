...
# Convert list → dict if scraper returned a list
    if isinstance(raw_scheme.get("eligibility"), list):
        raw_scheme["eligibility"] = {
        "other": raw_scheme["eligibility"],
        "age": "", "income": "", "occupation": "", "category": "", "land_required": ""
    }
    # ---------- 3. Eligibility ----------
...
# Map source_url → official_website so validator passes
    if not raw_scheme.get("official_website"):
        raw_scheme["official_website"] = raw_scheme.get("source_url", "")
